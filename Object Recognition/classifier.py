...
train_file = open('/home/avik/overfeat/code/train_features_new')
labels_file = open('/home/avik/overfeat/Images_new/labels.txt')
test_file = open('/home/avik/overfeat/code/test_features_new')
